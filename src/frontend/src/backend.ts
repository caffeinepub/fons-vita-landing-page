...
export class Backend implements backendInterface {
    ...
    async countContactForms(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countContactForms();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getComponentFeatures(): Promise<{
        aboutSection: boolean;
        heroSection: boolean;
        businessAreasSection: boolean;
        valuesSection: boolean;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getComponentFeatures();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
